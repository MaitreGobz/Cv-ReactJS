    ...
    return(
        <div className="row justify-content-center py-5 my-5">
            <div className="col-md">
                <div className="card image-card m-2" style={{minHeight: "20rem"}}>
                    <img src={Ecran} className="logo-img rounded mx-auto d-block mt-4" alt="logo écran" width={'50'}/>
            ...
            <div className="col-md">
                <div className="card image-card m-2" style={{minHeight: "20rem"}}>
                    <img src={Code} className="logo-img rounded mx-auto d-block mt-4" alt="logo écran" width={'50'}/>
                    <div className="card-body">
            ...
            <div className="col-md">
                <div className="card image-card m-2" style={{minHeight: "20rem"}}>
                    <img src={SEO} className="logo-img rounded mx-auto d-block mt-4" alt="logo écran" width={'50'}/>
                    <div className="card-body">
